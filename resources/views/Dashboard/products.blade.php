								...
								<div class="card">
									<div class="card-body">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{URL::asset('public/assets/img/ecommerce/01.jpg')}}" alt="product-image">
								...
								<div class="card">
									<div class="card-body">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{URL::asset('public/assets/img/ecommerce/02.jpg')}}" alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
										<div class="text-center pt-3">
								...
								<div class="card">
									<div class="card-body">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{URL::asset('public/assets/img/ecommerce/03.jpg')}}" alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
										<div class="text-center pt-3">
								...
								<div class="card">
									<div class="card-body">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{URL::asset('public/assets/img/ecommerce/06.jpg')}}" alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
										<div class="text-center pt-3">
								...
								<div class="card">
									<div class="card-body">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{URL::asset('public/assets/img/ecommerce/04.jpg')}}" alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart"></i>
											</a>
										</div>
										<div class="text-center pt-3">
								...
								<div class="card">
									<div class="card-body">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{URL::asset('public/assets/img/ecommerce/05.jpg')}}" alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
										<div class="text-center pt-3">
								...
								<div class="card">
									<div class="card-body">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{URL::asset('public/assets/img/ecommerce/09.jpg')}}" alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
										<div class="text-center pt-3">
								...
								<div class="card">
									<div class="card-body">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{URL::asset('public/assets/img/ecommerce/11.jpg')}}" alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
										<div class="text-center pt-3">
								...
								<div class="card">
									<div class="card-body">
										<div class="pro-img-box">
											...
											<img class="w-100" src="{{URL::asset('public/assets/img/ecommerce/07.jpg')}}" alt="product-image">
											<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
											</a>
										</div>
										<div class="text-center pt-3">
