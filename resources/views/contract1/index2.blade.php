  ...
  <div class="page-height">
      ...
      <div class="container">
          ...
          <ul class="fw-normal fs-5">
              <li>سعر المتر المربع مصنعية لياسة داخلية شاملاً للحوائط والأسقف والسور <span class="c-red"> {{$pdf->price1}} ريال
                    سعودي.</span></li>
              <li>سعر المتر المربع مصنعية لياسة خارجية <span class="c-red"> {{$pdf->price2}} ريال سعودي.</span></li>
          </ul>
