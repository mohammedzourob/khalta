                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0" style="text-align: center" >{{trans('occupation.Processes')}}</th>
                            </tr>
                            </thead>
                            <tbody>
{{--                            <?php $i = 0; ?>--}}
{{--                            @foreach ($about_us as $x)--}}
{{--                                <?php $i++; ?>--}}
                                <tr>
                                    <form action="settings/update" method="post" autocomplete="off" enctype="multipart/form-data">
                                        {{ method_field('patch') }}
                                        {{ csrf_field() }}
                                    <td style="text-align: center" >من نحن</td>
                                    <td>
                                        <textarea name="content">  {{ $about_us->content }}</textarea>
                                      </td>
                                ...
                                <tr>
                                    ...
                                    <form action="settings/update" method="post" autocomplete="off" enctype="multipart/form-data">
                                        ...
                                        {{ csrf_field() }}
                                    <td>
                                        <textarea name="terms_conditions">  {{ $about_us->terms_conditions }}</textarea>
...
{{--                                           data-id="{{ $about_us->id }}" data-name="{{ $about_us->content }}"--}}
{{--                                           data-description="" data-toggle="modal"--}}
{{--                                           href="#exampleModal2" title="تعديل"><i class="las la-eye"></i></a>--}}
