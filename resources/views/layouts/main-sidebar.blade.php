        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/dashboard') }}">
                    <img class="side-menu__icon" src="{{url('https://img.icons8.com/fluency/48/000000/dashboard-layout.png')}}" style=" width: 30px; height: 30px;"/>
                    <span class="side-menu__label" style=" font-weight: bold;">{{trans('main_trans.Dashboard')}}</span>
                </a>
            </li>
            					...
            					<li class="slide">
                                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                        <img   class="side-menu__icon" style=" width: 30px; height: 30px;"  src="{{url('https://img.icons8.com/external-icongeek26-outline-colour-icongeek26/64/000000/external-monitor-online-education-icongeek26-outline-colour-icongeek26-1.png')}}"/>
                                        <span class="side-menu__label" style=" font-weight: bold;">{{trans('main_trans.users_admin')}}</span>
                                        <i class="angle fe fe-chevron-down"></i></a>
                                    <ul class="slide-menu">
                                        <li><a class="slide-item" style=" font-weight: bold;" href="{{ url('/' . $page='dashboard/users_admin') }}">{{trans('main_trans.admin')}}</a></li>
                                        <li><a class="slide-item" style=" font-weight: bold;" href="{{ url('/' . $page='dashboard/user_supervisor') }}">{{trans('main_trans.supervisor')}}</a></li>
                                        <li><a class="slide-item" style=" font-weight: bold;" href="{{ url('/' . $page='dashboard/user_customers') }}">{{trans('main_trans.Professionals')}}</a></li>
                                    </ul>
                                ...
                                <li class="slide">
            						<a class="side-menu__item" href="{{ url('/' . $page='dashboard/contracts') }}">
                                        <img class="side-menu__icon" src="{{url('https://img.icons8.com/nolan/64/services.png')}}" style=" width: 30px; height: 30px;"/>
                                        <span class="side-menu__label" style=" font-weight: bold;">العقود</span>
                                    <?php
                                    $Contracts=\App\Models\Contracts::where('viewing_status','0')->count();
                                    ?>
                                    @if($Contracts != 0)
                                        <span class="badge bg-danger  text-light" id="bg-side-text">
                                           {{$Contracts}}
                                         </span>
                                    @endif
                                    </a>
            					   ...
            					   <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/clearance_cases') }}">
                    <img class="side-menu__icon" src="{{url('https://img.icons8.com/external-bearicons-gradient-bearicons/64/000000/external-approval-approved-and-rejected-bearicons-gradient-bearicons.png')}}" style=" width: 30px; height: 30px;"/>
                    <span class="side-menu__label" style=" font-weight: bold;">المخالصة النهائية</span>
           <?php
                    $clearance_cases=\App\Models\Contracts::where('Clearance_viewing_status','0')->count();
                    ?>
                    @if($clearance_cases != 0)
                        <span class="badge bg-danger  text-light" id="bg-side-text">
                                           {{$clearance_cases}}
                                         </span>
                    @endif
                            ...
                            <li class="slide">
                                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/invoices') }}">
                                    <img class="side-menu__icon" style=" width: 30px; height: 30px;" src="{{url("https://img.icons8.com/external-icongeek26-outline-colour-icongeek26/64/000000/external-invoices-oil-industry-icongeek26-outline-colour-icongeek26.png")}}"/>
                                    <span class="side-menu__label" style=" font-weight: bold;">الفواتير</span>
                                    <?php
                                    $invoices=\App\Models\Invoices::where('viewing_status','0')->count();
                                    ?>
                                    @if($invoices != 0)
                                    <span class="badge bg-danger  text-light" id="bg-side-text">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/work') }}">
                                    <img class="side-menu__icon" style=" width: 30px; height: 30px;" src="{{url("https://img.icons8.com/nolan/64/work.png")}}"/>

                                    <span class="side-menu__label" style=" font-weight: bold;">الاعمال</span>
                                    <?php
                                    $Work=\App\Models\Work::where('viewing_status','0')->count();
                                    ?>
                                    @if($Work != 0)
                                        <span class="badge bg-danger  text-light" id="bg-side-text">
                                        {{$Work}}
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/schedule_of_work') }}">
                    <img class="side-menu__icon" style=" width: 30px; height: 30px;" src="{{url("https://img.icons8.com/external-xnimrodx-lineal-gradient-xnimrodx/64/000000/external-mail-job-amp-resume-xnimrodx-lineal-gradient-xnimrodx.png")}}"/>

                    <span class="side-menu__label" style=" font-weight: bold;">جدول الاعمال</span>

                    <?php
                    $Schedule_of_work=\App\Models\Schedule_of_work::where('viewing_status','0')->count();
                    ?>
                    @if($Schedule_of_work != 0)
                        <span class="badge bg-danger  text-light" id="bg-side-text">
                            {{$Schedule_of_work}}
                        </span>
                    @endif
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/bond') }}">
                    <img class="side-menu__icon" style=" width: 30px; height: 30px;" src="{{url("https://img.icons8.com/nolan/64/bonds.png")}}"/>
                    <span class="side-menu__label" style=" font-weight: bold;">السندات</span>
                    <?php
                    $Bond=\App\Models\Bond::where('viewing_status','0')->count();
                    ?>
                    @if($Bond != 0)
                        <span class="badge bg-danger  text-light" id="bg-side-text">
                            {{$Bond}}
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/connect_us') }}">

                    <img class="side-menu__icon" style=" width: 30px; height: 30px;" src="{{url("https://img.icons8.com/external-inipagistudio-lineal-color-inipagistudio/64/000000/external-career-language-learning-inipagistudio-lineal-color-inipagistudio.png")}}"/>
                    <span class="side-menu__label" style=" font-weight: bold;">تواصل معنا</span>
                    <?php
                    $Connect_us=\App\Models\Connect_us::where('viewing_status','0')->count();
                    ?>
                    @if($Connect_us != 0)
                        <span class="badge bg-danger  text-light" id="bg-side-text">
                            {{$Connect_us}}
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/notification') }}">
                    <img class="side-menu__icon" style=" width: 30px; height: 30px;" src="{{url("https://img.icons8.com/nolan/50/appointment-reminders.png")}}"/>
                    <span class="side-menu__label" style=" font-weight: bold;">الأشعارات</span>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/projects') }}">
                    <img class="side-menu__icon" style=" width: 30px; height: 30px;" src="{{url('https://img.icons8.com/external-itim2101-blue-itim2101/64/000000/external-mechanic-life-style-avatar-itim2101-blue-itim2101.png')}}"/>
                    <span class="side-menu__label" style=" font-weight: bold;">{{trans('main_trans.projects')}}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/sections') }}">

                    <img class="side-menu__icon"  src="{{url('https://img.icons8.com/nolan/64/sorting-answers.png')}}" style=" width: 30px; height: 30px;"/>
                    <span class="side-menu__label" style=" font-weight: bold;">الاقسام</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/special_conditions') }}">
                    <img class="side-menu__icon" style=" width: 30px; height: 30px;" src="{{url('https://img.icons8.com/nolan/64/paste-special.png')}}"/>
                    <span class="side-menu__label" style=" font-weight: bold;">ملحقات الشروط الخاصة</span></a>
            </li>



            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='dashboard/settings') }}">
                    <img class="side-menu__icon" style=" width: 30px; height: 30px;" src="{{url("https://img.icons8.com/nolan/64/settings--v1.png")}}"/>
                    <span class="side-menu__label" style=" font-weight: bold;">الأعدادات</span></a>
            </li>
