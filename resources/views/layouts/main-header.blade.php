...
{{--									<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>Profile</a>--}}
									<a class="dropdown-item" href="{{url('dashboard/users_admin/'.Auth::user()->id.'/edit')}}"><i class="bx bx-cog"></i> {{trans('main_trans.Edit_Profile')}}</a>
									<a class="dropdown-item" href="{{url('/dashboard')}}"><i class="bx bxs-inbox"></i>Inbox</a>
									<a class="dropdown-item" href="{{url('dashboard/connect_us')}}"><i class="bx bx-envelope"></i>{{trans('main_trans.Messages')}}</a>
