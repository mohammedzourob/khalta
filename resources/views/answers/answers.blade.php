                    ...
                    <div class="row row-xs wd-xl-80p">
                        <div class="col-sm-6 col-md-3 mg-t-10">
                            <button class="btn btn-info-gradient btn-block">
                                <a  data-toggle="modal" href="#modaldemo8" style="font-weight: bold; color: beige;">إضافة جواب</a>
                            </button>
...
{{--                                <th class="border-bottom-0">السؤال</th>--}}
                                ...
                                <th class="border-bottom-0">الاجوبة</th>
...
{{--                                            <a   href="{{url('dashboard/answers/index/'.$x->id)}}" style="font-weight: bold; color: beige;">الاجوبة</a>--}}
...
{{--                                    </td>--}}
                                    ...
                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                       data-id="{{ $x->id }}" data-name="{{ $x->title }}"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">إضافة جواب</h6><button aria-label="Close" class="close" data-dismiss="modal"
                        ...
                        <form action="{{ route('answers.store') }}" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="question_id" id="select-beast" class="form-control form-control-md nice-select  custom-select">
{{--                                        @foreach ($special_conditions as $z)--}}
                                        <option value="{{$special_conditions->id}}">{{$special_conditions->question}}</option>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('answers.update') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            {{ method_field('patch') }}
                            {{ csrf_field() }}
...
{{--                                <div class="form-group col-md-12">--}}
{{--                                    <label for="exampleInputEmail1">قسم السؤال :</label>--}}
        ...
        <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('answers.destroy') }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
