...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('users_admin.users')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> / {{trans('users_admin.admin_users')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <div class="col-sm-6 col-md-3 mg-t-10">
                        ...
                        <!--    <a href="{{ route('users_admin.create')}}" style="font-weight: bold; color: beige;">{{trans('users_admin.add_users')}}</a>-->
                        <!--</button>-->
...
{{--                        <button class="btn btn-info-gradient btn-block" >--}}
{{--                            <a class="btn  btn-block" data-effect="effect-scale"--}}
{{--                             href="{{ route('users_admin.create')}}" style="font-weight: bold; color: beige;">{{trans('users_admin.add_users')}}</a></button>--}}
{{--                    </div>--}}
                </div>
                <div class="card-body">
                    <div class="table-responsive hoverable-table">
                        <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">{{trans('users_admin.users_name')}}</th>
                                <th class="wd-20p border-bottom-0">{{trans('users_admin.users_email')}}</th>
                                <th class="wd-15p border-bottom-0">{{trans('users_admin.user_status')}}</th>
{{--                                <th class="wd-15p border-bottom-0">نوع المستخدم</th>--}}
                                <th class="wd-10p border-bottom-0">{{trans('users_admin.Processes')}}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $i = 0; ?>
...
{{--                                                                        </td>--}}
                                    ...
                                    <td>
                                            ...
                                            <a href="{{ route('users_admin.edit', $user->id) }}" class="btn btn-sm btn-info"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">{{trans('users_admin.delete_users')}}</h6><button aria-label="Close" class="close"
                                                                         data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <form action="users_admin/destroy" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">{{trans('users_admin.Close')}}</button>
