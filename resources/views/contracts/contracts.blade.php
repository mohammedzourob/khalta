...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{trans('occupation.Settings')}}</h4><span
...
<div class="row">
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='10'
                        ...
                        <thead>
                            <tr>
                                ...
                                {{--                                <th class="border-bottom-0">{{trans('occupation.Profession_name')}}
                                </th>--}}
                                ...
                                <th class="border-bottom-0">اضافة مشرف</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-dark-gradient btn-block"
                                        data-effect="effect-scale" data-id="{{ $x->id }}" data-description=""
                                ...
                                <td>
                                    <button class="btn btn-dark-gradient btn-block">
                                        <a href="{{url('dashboard/answers_special_conditions/'.$x->id)}}"
                                            style="font-weight: bold; color: beige;">الشروط الخاصة</a>
                                ...
                                <td id="dynamic_field_{{$x->id}}" style="">
                                    ...
                                    <div>
                                        <input type="button" class="btn btn-success-gradient btn-block"
                                            value='تمت المشاهدة '>
                                    </div>
                                    @else
                                    <input type="button" class="btn btn-danger-gradient btn-block update"
                                        value='غير مشاهدة ' data-id='{{$x->id}}'
                                        data-viewing_status="{{$x->viewing_status}}">
                                    @endif
                                </td>
                                {{--                                    <td>--}}
                                {{--                                        <button class="btn btn-info -gradient btn-block">--}}
                                {{--                                            <a   href="{{url('dashboard/notification/'.$x->id)}}"
                                style="font-weight: bold; color: beige;">الاشعارت</a>--}}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{trans('occupation.add_profession')}}</h6><button aria-label="Close"
                    ...
                    <form action="{{ route('sections.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="project_id" id="select-beast"
                                    class="form-control form-control-md nice-select  custom-select">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">{{trans('occupation.Close')}}</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal" id="modaldemo9">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">بيانات العقد</h6><button aria-label="Close" class="close"
    ...
    <div class="modal" id="modaldemo15">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">انتهاء حالة العقد</h6><button aria-label="Close" class="close"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="updatesupervisor" method="post" autocomplete="off" enctype="multipart/form-data">
                        {{ method_field('patch') }}
                        {{ csrf_field() }}
                        <input type="hidden" name="id" id="id" value="">
                        <div class="row">
