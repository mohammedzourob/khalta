...
{{--                                <th class="border-bottom-0">{{trans('occupation.Profession_name')}}</th>--}}
                                ...
                                <th class="border-bottom-0">صورة الفاتورة</th>
                                <th class="border-bottom-0">اسم الفاتورة</th>
...
{{--                                        </div>--}}
{{--                                        <div class="HoverDiv">--}}
{{--                                            <img src="{{url('/')."/".$x->image}}" alt="Smiley face">--}}
{{--                                        </div>--}}

                                        <a class="modal-effect" data-effect="effect-scale"
                                           data-id="{{ $x->id }}" data-image="{{url('/')."/".$x->image}}"
                                           data-toggle="modal" href="#modaldemo9" title="عرض">

                                            <img src="{{url('/')."/".$x->image}}" style="
                                            width: 50px;
                                            height: 50px";>
                                        </a>
                                    </td>
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">تعديل حالة الفاتورة</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="updatestatusinvoices" method="post" autocomplete="off" enctype="multipart/form-data">
                            {{ method_field('patch') }}
                            {{ csrf_field() }}
