...
{{--1--}}
  ...
  <div class="page-height page2">
      <img class="logo" src="{{('/image/logo.png')}}" alt="logo" style="margin-bottom: 0px;" />
      ...
      <div class="container">
          ...
          <ul class="fw-normal fs-5">
              <li>سعر المتر المربع للسقر مصنعية دهان البلاستيك <span class="c-red">{{$pdf->price1}} ريال
                    سعودي.</span></li>
              <li> سعر المتر المربع مصنعية دهان لياتي <span class="c-red"> {{$pdf->price2}} ريال سعودي.</span></li>
              <li> سعر المتر المربع مصنعية ركة أو دهان خارجي (المسطحات التي تحتاج إلى سقايل) <span class="c-red"> {{$pdf->price3}} ريال سعودي.</span></li>
              <li> سعر دهان الباب الخشبي الواحد بما فيه الحلق <span class="c-red"> {{$pdf->price4}} ريال سعودي.</span></li>
              <li> سعر دهان الباب الحديدي الواحد بما فيه الحلق <span class="c-red"> {{$pdf->price5}} ريال سعودي.</span></li>
          </ul>

          <p class="fw-bold  ">12- الدفعات:</p>
          ...
          <ul class="fw-normal fs-5">
              <li>
                  دفعة <span class="c-red"> {{$pdf->paying1}} %</span> بعد <span
                      class="c-red">{{$pdf->payment_content1}}</span>
              </li>
          ...
          <p class="fw-normal fs-5">المعتمد في صافي أتعاب الطرف الثاني هو القياس على الطبيعة في نهاية العقد مع اعتبار ما
              يلي:</p>
          <ul>
              <p class=" fs-5">أ- البرولات والكرانيش تحسب من ضمن مسطحات التمتير.</p>
