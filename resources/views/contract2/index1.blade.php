...
{{--1--}}
    <div class="container">
      ...
      <div>
        ...
        <p class="fw-normal fs-5">
          2- تكون مهام عمل الطرف الثاني مصنعية كل ما يتعلق بالعظم والمباني
  ...
  <div class="page-height">
      ...
      <div class="container">
          ...
          <ul class="fw-normal fs-5">
              <li>سعر المتر المربع للسقف أو الملاحق العلوية أو بيت الدرج  <span class="c-red">........ ريال
                    سعودي.</span> ، شاملاً الدرج وصبة
                  الدور الأرضي وكافة الجسور المقلوبة.</li>
              <li>سعر المتر الطولي للسور بما فيه البوابات <span class="c-red"> .......... ريال سعودي.</span></li>
              <li>سعر المتر الطولي للسترة  <span class="c-red"> .......... ريال سعودي.</span></li>
              <li>سعر المتر المربع للخزان الأرضي أو القبو <span class="c-red"> .......... ريال سعودي.</span></li>
              <li>سعر المتر المربع للبياره <span class="c-red"> .......... ريال سعودي.</span></li>
          </ul>
  ...
  <div class="page-height">
      ...
      {{--3--}}
      <div class="container">
          <p class="fw-bold fs-4">13- القياس والتمتير:</p>
          <p class="fw-normal fs-5">المعتمد في صافي أتعاب الطرف الثاني هو القياس على الطبيعة في نهاية العقد مع اعتبار ما
              يلي:</p>
          <ul>
              <p class="fw-normal fs-5">أ- البرولات والكرانيش إلى 10 سم ال تحسب من ضمن المتر، وفي حال زاد عن 10 سم تحسب
...
<br>
  ...
  <div class="page-height page5">
      ...
      <div class="container">
          ...
          <div class="form-check fw-normal fs-5 mb-5" dir="rtl">
              <input type="checkbox" />
              <label class="form-check-label"> المقاول </label>
          </div>
  ...
  <div class="page-height page7">
      ...
      <img class="footer" src="{{('/image/footer.png')}}" alt="footer image"  style="margin-top: 460px;"/>
  </div>
