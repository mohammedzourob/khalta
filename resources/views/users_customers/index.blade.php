    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ العملاء</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div class="row row-xs wd-xl-80p">
                        <div class="col-sm-6 col-md-3 mg-t-10">
                            <button class="btn btn-info-gradient btn-block">
                                <a href="{{ route('user_customers.create')}}" style="font-weight: bold; color: beige;">{{trans('users_admin.add_users')}}</a>
                            </button>
                        ...
                        <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                            ...
                            <tr>
                                ...
                                <th class="wd-20p border-bottom-0">{{trans('users_visitors.users_email')}}</th>
                                  <th class="wd-20p border-bottom-0">رقم الموبايل</th>
                                         ...
                                         <td>{{ $user->phone }}</td>
                                               <td style="">
                                                   @if ($user->Status == 1)
                                                       ...
                                                       <button class="btn btn-success-gradient btn-block">فعالة</button>

                                                   @else
                                                       <button class="btn btn-danger-gradient btn-block">غير فعالة</button>
...
{{--                                                                        </td>--}}
                                    ...
                                    <td>
                                            ...
                                            <a href="{{ route('user_customers.edit', $user->id) }}" class="btn btn-sm btn-info"
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="user_customers/destroy" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
