...
class UserCustomersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('users_customers.index',compact('data'));
    }
    ...
    {
        return view('users_customers.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('dashboard/user_customers');
    }
...
//        $userRole = $user->roles->pluck('name','name')->all();
        return view('users_customers.edit',compact('user'));
    }
